...
plt.plot(diff_data,diff_data_number,color="#0000ff",marker=".",label="算法工资类型")
...
plt.plot(edu_diff_data,edu_diff_data_number,color="#238E23",label="教育工资类型")
plt.plot(mech_diff_data,mech_diff_data_number,color="red",label="机器学习工资类型")
plt.plot(oper_diff_data,oper_diff_data_number,color="#6E238E",label="运维工资类型")
plt.plot(pro_diff_data,pro_diff_data_number,color="#99cc32",label="产品经理工资类型")
plt.plot(ui_diff_data,ui_diff_data_number,color="#412f1f",label="UI设计工资类型")

plt.legend()
plt.savefig("工资分布.png")
plt.show()