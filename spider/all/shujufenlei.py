...
# 设置数据库的连接
conn1 = pymysql.connect(host="localhost",user="root",passwd="123456",db="algorithm_engineer",charset="utf8")
conn = pymysql.connect(host="localhost",user="root",passwd="123456",db="all",charset="utf8")

# 获取数据
android_development = pda.read_excel("../data/android_development.xlsx",encoding="utf-8")
android_development = android_development.dropna()

big_data = pda.read_excel("../data/big_data.xlsx",encoding="utf-8")
big_data = big_data.dropna()

deep_learning = pda.read_excel("../data/deep_learning.xlsx",encoding="utf-8")
deep_learning = deep_learning.dropna()

education = pda.read_excel("../data/education.xlsx",encoding="utf-8")
education = education.dropna()

mechine_learning = pda.read_excel("../data/mechine_learning.xlsx",encoding="utf-8")
mechine_learning = mechine_learning.dropna()

nature_language_process = pda.read_excel("../data/nature_language_process.xlsx",encoding="utf-8")
nature_language_process = nature_language_process.dropna()

operate = pda.read_excel("../data/operate.xlsx",encoding="utf-8")
operate = operate.dropna()

operation_maintenance = pda.read_excel("../data/operation_maintenance.xlsx",encoding="utf-8")
operation_maintenance = operation_maintenance.dropna()

production_manager = pda.read_excel("../data/production_manager.xlsx",encoding="utf-8")
production_manager = production_manager.dropna()

ui_design = pda.read_excel("../data/ui_design.xlsx",encoding="utf-8")
